...
If you are selling products, you want to giv your customers access to your digital goods. With plenigo you simply use the method [hasAccess](https://api.plenigo.com/doc/v3/#/accessRights/get_accessRights__customerId__hasAccess)
...
try {
   ...
   $access = $response->accessGranted; // here we get the access status
    ...
    // Guzzle loves to throw [Exceptions](http://docs.guzzlephp.org/en/stable/quickstart.html#exceptions) 
