...
```
**Note:** You can configure the `plenigo.registration()` method:  [Frisbii Media login](https://plenigo.github.io/sdks/javascript#login---open-the-plenigo-login-window)
